...
if (!isset($_SESSION['logged_in']) || $_SESSION['logged_in'] !== true) {
    ...
    if ($_SESSION['level'] === 'admin' || $_SESSION['level'] === 'seller') {
        ...
        // Jika level tidak dikenal, logout dan kembali ke login
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="navbar-toggler">
                <div class="d-flex">
                    <div class="search-shoes bg-prime rounded-pill py-2 px-3">
                        <form class="d-flex" x-data="{ open: false }" action="template/search-recommendation.php" method="POST">
                            <!-- Input Search -->
                            <input
                                type="text"
                                name="search-oi"
            ...
            <div class="collapse navbar-collapse text-prime fw-semibold" id="navbarNav">
                <ul class="navbar-nav ms-auto fs-7">
                    <li class="nav-item bg-prime py-2 px-3 me-4" style="width:27vw; border-radius:15px">
                        <form class="d-flex" action="template/search-recommendation.php" method="POST">
                    ...
                    <li class="nav-item px-2">
                        <a class="nav-link" href="index.php?page=seller">Seller</a>
                    </li>
                    <li class="d-flex gap-2">
                        <button class="btn-second rounded-pill rounded-pill fs-8 px-3  ms-2" onclick="window.location.href='index.php?page=login'">
                            Sign In
                        </button>
                        <button class="btn-outline-second rounded-pill fs-8 px-3" onclick="window.location.href='index.php?page=signup'">
                            Sign Up
                        </button>
                    </li>
                </ul>
    ...
    switch ($page) {
        ...
        case 'produk':
            ...
            break;
        case 'all-produk':
            include 'template/all-produk.php';
            break;
        case 'seller':
            include 'template/seller.php';
            break;
        case 'daftar-seller':
