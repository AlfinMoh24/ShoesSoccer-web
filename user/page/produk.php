            ...
            <div class="produk-detail">
                ...
                <div class="d-flex mt-4 align-items-center gap-2">
                    ...
                    <form action="../admin/aksi/tambah.php" method="post">
                        ...
                        <input type="hidden" name="jumlah" id="jumlah-cart" value="1">
                        <button type="submit" class="btn-outline-second fs-8 px-3 py-2 rounded-pill">+ Add to cart</button>
                    </form>
                    <button class="btn-second fs-8 px-4 py-2 rounded-pill" id="openModalButton">Buy Now</button>
                </div>
                <br>
                <span>
